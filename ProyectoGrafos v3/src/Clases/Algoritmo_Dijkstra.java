...
import static Ventanas.Pantalla.jPanel1;
import static Ventanas.Pantalla.R_repaint;
...
public class Algoritmo_Dijkstra {
   ...
   private int nodoFin; 
    ...
    public Algoritmo_Dijkstra (Grafo arboles, int tope,int permanente, int nodoFin){
    ...
    public void dijkstra() {
        ...
        if (permanente != nodoFin) {
            ...
            if (auxi.getPredecesor() == null) {
                JOptionPane.showMessageDialog(null, "El grafo es disconexo");
            }
