...
int i;
        ...
        for (int j = 0; j < i; j++) {
            for (int k = 0; k < i; k++) {
                if (arboles.getmAdyacencia(j, k) == 1) {
                    Pintar.pintarLinea(Pantalla.jPanel1.getGraphics(), arboles.getCordeX(j), arboles.getCordeY(j), arboles.getCordeX(k), arboles.getCordeY(k), arboles.getmCoeficiente(j, k));
                }
            }
        }
        for (int j = 0; j < i; j++) {
            Pintar.pintarCirculo(Pantalla.jPanel1.getGraphics(), arboles.getCordeX(j), arboles.getCordeY(j), String.valueOf(arboles.getNombre(j)));
    ...
    private void initComponents() {
        ...
        jPanel1.setBounds(10, 10, 130, 90);
        ...
        jButton1.setBounds(30, 110, 90, 24);

        setBounds(60, 130, 163, 179);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        JOptionPane.showMessageDialog(null,"Error.. Faltan datos : ");
            ...
            JOptionPane.showMessageDialog(null,"Error.. Debe digitar un nodo diferente a : "+y);
                ...
                n1.setText(null);
                n2.setText(null);
                Pantalla.jPanel1.paint(Pantalla.jPanel1.getGraphics());
